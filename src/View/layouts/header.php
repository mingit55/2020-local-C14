...
<body>
    <!-- 로그인 -->
    <form id="sign-in" action="/sign-in" method="post" class="modal fade">
    ...
    <!-- /로그인 -->
    <!-- 회원가입 -->
    <form id="sign-up" action="/sign-up" method="post" enctype="multipart/form-data" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body px-4 pt-4 pb-3">
                    <div class="title text-center">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" id="join_photo" class="custom-file-input" name="photo" accept="image/*" required>
                        ...
                        <div class="form-group">
                            ...
                            <canvas id="cap_canvas" width="450" height="100" class="w-100 border"></canvas>
    ...
    <header <?=$viewName !=="index" ? "class='no-visual'" : ""?>>
        <!-- GNB -->
        <div id="gnb">
            <div class="d-between h-100 align-items-lg-end px-4 py-3">
                <a href="/">
