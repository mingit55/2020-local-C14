class Product {
    ...
    get totalPrice(){
        return this.json.price * this.buyCount;
    }
    ...
    cartUpdate(){
        ...
        if(!this.$cartElem) {
            this.$cartElem = $(`<div class="table-item">
                                    <div class="cell-50">
                                        <div class="text-left d-flex align-items-center">
                                            ...
                                            <div class="px-4" style="width: calc(100% - 80px)">
                                                <div class="text-ellipsis fx-n2 text-muted">${brand}</div>
                                    ...
                                    <div class="cell-15">
                                        <button class="remove px-2 py-1 text-white bg-blue" data-id="${id}">×</button>
                                    </div>
                                </div>`);
        } else {
